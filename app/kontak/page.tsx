...
export default function KontakPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0C10] text-white pt-16 pb-24 overflow-x-hidden">
      ...
      {/* UTAMA: INTERACTIVE HUB & FORM KONSULTASI */}
      <section className="container mx-auto px-6 max-w-5xl mt-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
          
          {/* SISI KIRI (INFO KANTOR & TOMBOL AKSES INSTAN WITH SVG ICONS) */}
          ...
          {/* SISI KANAN (FORMULIR KASUS LEGAL INQUIRY) */}
          <div className="md:col-span-3 bg-zinc-900/10 border border-zinc-800/60 rounded-xl p-6 md:p-8 backdrop-blur-sm shadow-xl">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  KIRIM PERMOHONAN JADWAL KONSULTASI →
                </button>
