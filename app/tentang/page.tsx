...
export default function TentangPage() {
  return (
    <div className="min-h-screen bg-[#0B0C10] text-white pt-16 overflow-x-hidden">
      ...
      {/* INJECT ANIMASI FLOATING SECARA INSTAN & HALUS BAWAAN */}
      <style jsx global>{`
        @keyframes floatSlow {
      ...
      {/* 1. HERO HEADER - Pop-in instant pas load awal tanpa nunggu scroll */}
      <section 
      ...
      {/* 2. FILOSOFI NAMA (INTRO) - Animasi memudar naik saat di-scroll */}
      <section className="container mx-auto px-6 max-w-4xl mt-16 mb-20">
        <ScrollAnimate>
          <div className="bg-zinc-900/20 border border-zinc-800/60 rounded-2xl p-8 md:p-12 shadow-xl backdrop-blur-sm relative overflow-hidden group hover:border-amber-500/20 transition-colors duration-500">
      ...
      {/* 3. PILAR PRINSIP KERJA - Judul & Kartu Grid dengan Efek Staggered Delay */}
      <section className="bg-[#050505] py-16 border-y border-zinc-900">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Pilar 1: Solusi Hukum */}
            <ScrollAnimate delay={0} className="h-full">
              <div className="bg-[#0B0C10] border border-zinc-800/60 p-6 sm:p-8 rounded-xl hover:border-amber-500/30 transition-all duration-300 group h-full flex flex-col">
                <div className="text-amber-500 mb-4 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 origin-left">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                  </svg>
                </div>
                <h4 className="text-lg font-bold text-white mb-3 tracking-wide group-hover:text-amber-400 transition-colors">Solusi Hukum</h4>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed text-left font-light flex-1">
            ...
            <ScrollAnimate delay={150} className="h-full">
              <div className="bg-[#0B0C10] border border-zinc-800/60 p-6 sm:p-8 rounded-xl hover:border-amber-500/30 transition-all duration-300 group h-full flex flex-col">
                ...
                <h4 className="text-lg font-bold text-white mb-3 tracking-wide group-hover:text-amber-400 transition-colors">Keadilan</h4>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed text-left font-light flex-1">
            ...
            {/* Pilar 3: Kepercayaan (Delay 300ms) */}
            <ScrollAnimate delay={300} className="h-full">
              <div className="bg-[#0B0C10] border border-zinc-800/60 p-6 sm:p-8 rounded-xl hover:border-amber-500/30 transition-all duration-300 group h-full flex flex-col">
                ...
                <h4 className="text-lg font-bold text-white mb-3 tracking-wide group-hover:text-amber-400 transition-colors">Kepercayaan</h4>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed text-left font-light flex-1">
